...
arch_6502_get_op8(uint8_t *RAM, uint16_t pc, BasicBlock *bb) {
	return ConstantInt::get(bb_getType(bb, Int32Ty), OPERAND_8);
}

Value *
arch_6502_get_op16(uint8_t *RAM, uint16_t pc, BasicBlock *bb) {
	return ConstantInt::get(bb_getType(bb, Int32Ty), OPERAND_16);
}
...
arch_6502_load_ram_16(int is_32, Value *addr, BasicBlock *bb) {
	ConstantInt* const_int32_0001 = ConstantInt::get(bb_getType(bb, Int32Ty), 0x0001);
	ConstantInt* const_int32_0008 = ConstantInt::get(is_32? bb_getType(bb, Int32Ty) : bb_getType(bb, Int16Ty), 0x0008);

	/* get lo */
	Value *lo = arch_6502_load_ram_8(addr, bb);
	Value *lo32 = new ZExtInst(lo, bb_getIntegerType(bb, is_32? 32:16), "", bb);

	/* get hi */
	addr = BinaryOperator::Create(Instruction::Add, addr, const_int32_0001, "", bb);
	Value *hi = arch_6502_load_ram_8(addr, bb);
	Value *hi32 = new ZExtInst(hi, bb_getIntegerType(bb, is_32? 32:16), "", bb);
...
arch_6502_add_index(Value *ea, Value *index_register, BasicBlock *bb) {
	...
	CastInst* index32 = new ZExtInst(index, bb_getIntegerType(bb, 32), "", bb);
...
arch_6502_get_operand_lvalue(uint8_t* RAM, addr_t pc, BasicBlock* bb) {
	...
	printf("is_8bit = %x\n", is_8bit);
#endif
	ConstantInt* const_int32_FFFF = ConstantInt::get(bb_getType(bb, Int32Ty), 0xFFFF);
	ConstantInt* const_int32_00FF = ConstantInt::get(bb_getType(bb, Int32Ty), 0x00FF);

	/* create base constant */
	uint16_t base = is_8bit? (OPERAND_8):(OPERAND_16);
	Value *ea = ConstantInt::get(bb_getType(bb, Int32Ty), base);
...
arch_6502_get_operand_rvalue(uint8_t* RAM, addr_t pc, BasicBlock* bb)
{
	switch (instraddmode[OPCODE].addmode) {
		case ADDMODE_IMM:
			return ConstantInt::get(bb_getType(bb, Int8Ty), OPERAND_8);
		default:
...
{
	ConstantInt* const_int8_00 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x00);
...
{
	ConstantInt* v_pc = ConstantInt::get(bb_getType(bb, Int16Ty), pc);
	new StoreInst(v_pc, ptr_PC, bb);
	ReturnInst::Create(BB_CTX(bb), ConstantInt::get(bb_getType(bb, Int32Ty), (uint32_t)-1), bb);//XXX needs #define
}
...
{
	ConstantInt* const_int8_0000 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0000);
	ConstantInt* const_int8_0001 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0001);
	ConstantInt* const_int8_0007 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0007);
	...
	if (rotate) {	/* shift in carry */
		...
		c = new ZExtInst(c, bb_getIntegerType(bb, 8), "", bb);
		if (!left)
	...
	if (left)	/* old MSB to carry */
		...
		c = new TruncInst(v1, bb_getIntegerType(bb, 1), "", bb);
...
arch_6502_addsub(uint8_t *RAM, uint16_t pc, Value *reg, Value *reg2, int is_sub, int with_carry, BasicBlock *bb) {
	ConstantInt* const_int16_0001 = ConstantInt::get(bb_getType(bb, Int16Ty), 0x0001);
	ConstantInt* const_int16_0008 = ConstantInt::get(bb_getType(bb, Int16Ty), 0x0008);
	ConstantInt* const_int8_00FF = ConstantInt::get(bb_getType(bb, Int8Ty), 0x00FF);
	...
	/* convert to 16 bits */
	v1 = new ZExtInst(v1, bb_getIntegerType(bb, 16), "", bb);
	v2 = new ZExtInst(v2, bb_getIntegerType(bb, 16), "", bb);
	...
	if (with_carry) {
		...
		old_c = new ZExtInst(old_c, bb_getIntegerType(bb, 16), "", bb);
	...
	c = new TruncInst(c, bb_getIntegerType(bb, 1), "", bb);
	new StoreInst(c, ptr_C, bb);

	/* get result */
	v1 = new TruncInst(v1, bb_getIntegerType(bb, 8), "", bb);
	if (reg2)
...
arch_6502_push(Value *v, BasicBlock *bb) {
	ConstantInt* const_int32_0100 = ConstantInt::get(bb_getType(bb, Int32Ty), 0x0100);
	ConstantInt* const_int8_0001 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0001);

	/* get pointer to TOS */
	Value *s = new LoadInst(ptr_S, "", false, bb);
	Value *s_ptr = new ZExtInst(s, bb_getIntegerType(bb, 32), "", bb);
...
arch_6502_push_c16(uint16_t v, BasicBlock *bb) {
	arch_6502_push(ConstantInt::get(bb_getType(bb, Int8Ty), v >> 8), bb);
	arch_6502_push(ConstantInt::get(bb_getType(bb, Int8Ty), v & 0xFF), bb);
}
...
{
	ConstantInt* const_int8_0007 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0007);
	ConstantInt* const_int8_0006 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0006);
	ConstantInt* const_int8_0003 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0003);
	ConstantInt* const_int8_0002 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0002);
	ConstantInt* const_int8_0001 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0001);
	...
	Value *c = new LoadInst(ptr_C, "", false, bb);
	n = new ZExtInst(n, bb_getIntegerType(bb, 8), "", bb);
	v = new ZExtInst(v, bb_getIntegerType(bb, 8), "", bb);
	d = new ZExtInst(d, bb_getIntegerType(bb, 8), "", bb);
	i = new ZExtInst(i, bb_getIntegerType(bb, 8), "", bb);
	z = new ZExtInst(z, bb_getIntegerType(bb, 8), "", bb);
	c = new ZExtInst(c, bb_getIntegerType(bb, 8), "", bb);
...
arch_6502_flags_decode(Value *flags, BasicBlock *bb)
{
	...
	n = new TruncInst(n, bb_getIntegerType(bb, 1), "", bb);
	v = new TruncInst(v, bb_getIntegerType(bb, 1), "", bb);
	d = new TruncInst(d, bb_getIntegerType(bb, 1), "", bb);
	i = new TruncInst(i, bb_getIntegerType(bb, 1), "", bb);
	z = new TruncInst(z, bb_getIntegerType(bb, 1), "", bb);
	Value *c = new TruncInst(flags, bb_getIntegerType(bb, 1), "", bb);
	new StoreInst(n, ptr_N, bb);
...
arch_6502_recompile_instr(uint8_t* RAM, addr_t pc, BasicBlock *bb_dispatch, BasicBlock *bb) {
	...
	ConstantInt* const_false = ConstantInt::get(bb_getType(bb, Int1Ty), 0);
	ConstantInt* const_true = ConstantInt::get(bb_getType(bb, Int1Ty), 1);
	ConstantInt* const_int8_0001 = ConstantInt::get(bb_getType(bb, Int8Ty), 0x0001);
	...
	switch (instraddmode[opcode].instr) {
		...
		case INSTR_JMP:
			if (instraddmode[opcode].addmode == ADDMODE_IND) {
				Value *ea = ConstantInt::get(bb_getType(bb, Int32Ty), OPERAND_16);
				...
				if (target) {
					...
					ConstantInt* c = ConstantInt::get(bb_getType(bb, Int16Ty), OPERAND_16);
		...
		case INSTR_RTS:
			...
			lo = new ZExtInst(lo, bb_getIntegerType(bb, 16), "", bb);
			hi = new ZExtInst(hi, bb_getIntegerType(bb, 16), "", bb);
...
{
	// declare flags
	ptr_N = new AllocaInst(bb_getIntegerType(bb, 1), "N", bb);
	ptr_V = new AllocaInst(bb_getIntegerType(bb, 1), "V", bb);
	ptr_D = new AllocaInst(bb_getIntegerType(bb, 1), "D", bb);
	ptr_I = new AllocaInst(bb_getIntegerType(bb, 1), "I", bb);
	ptr_Z = new AllocaInst(bb_getIntegerType(bb, 1), "Z", bb);
	ptr_C = new AllocaInst(bb_getIntegerType(bb, 1), "C", bb);
